...
public class ExerciseListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pictures = getResources().obtainTypedArray(R.array.exercisePictures);
        nameTV = getResources().getStringArray(R.array.exerciseName);
        detailsTV = getResources().getStringArray(R.array.exerciseDetails);
        ...
        listViewTV.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(ExerciseListActivity.this, ExerciseDetails.class);
