...
import com.collegeproject.dev3dot.projecthealthcare.predictor.PeriodCalculator;
import com.collegeproject.dev3dot.projecthealthcare.util.AppPreferences;
import com.collegeproject.dev3dot.projecthealthcare.util.OptionalUtil;
import com.collegeproject.dev3dot.projecthealthcare.validator.IntegerWithinRange;
import com.google.common.base.Optional;

import org.joda.time.LocalDate;

public class PreferenceActivity extends AppCompatActivity implements DatePickerFragment.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menstruationLength.addTextChangedListener(new IntegerWithinRange(menstruationLength, 1, 10));
    ...
    public void updatePreferences(View view) {
        ...
        finish();
        Intent intent = new Intent(PreferenceActivity.this, CalenderActivity.class);
