package com.collegeproject.dev3dot.projecthealthcare.period_days;
...
import com.collegeproject.dev3dot.projecthealthcare.util.LocalDateSerializer;
...
public class PeriodDaysManager {
    ...
    private static final Gson GSON = new GsonBuilder()
            ...
            .create();
    private static final Type PERIOD_DAYS_GSON_TYPE = new TypeToken<ArrayList<PeriodDaysBean>>() {
    }.getType();
